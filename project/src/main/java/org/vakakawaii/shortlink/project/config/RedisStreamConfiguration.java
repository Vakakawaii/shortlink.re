...
import org.vakakawaii.shortlink.project.mq.consumer.ShortLinkStatsSaveConsumer;
...
import static org.vakakawaii.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_GROUP_KEY;
import static org.vakakawaii.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_TOPIC_KEY;
...
public class RedisStreamConfiguration {
    ...
    //    使用这个在redis创建 stream 数据结构
    //    XADD "short-link:stats-stream" * "New key" "New value"
    //    xgroup create short-link:stats-stream short-link:stats-stream:only-group 0
